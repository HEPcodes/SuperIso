...
/*--------------------------------------------------------------------*/
/* Calculation of the observables, corresponding to a GMSB point generated by SOFTSUSY and/or ISAJET */
/*--------------------------------------------------------------------*/
...
int main(int argc,char** argv)
{
	...
	else
	{
...
#ifdef USE_SOFTSUSY
		sprintf(name,"gmsb_softsusy.lha");
		...
		sprintf(name,"rm gmsb_softsusy.lha");
		system(name);		
#endif

#ifdef USE_ISAJET
		sprintf(name,"gmsb_isajet.lha");
		...
		sprintf(name,"rm gmsb_isajet.lha");
		system(name);		
#endif
		return 1;
	}

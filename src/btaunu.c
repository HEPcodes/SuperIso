...
/* computes the branching ratio of B-> tau nu */
{
	...
	if(param->SM==1)	return param->life_B/hbar*param->m_B/8./pi*pow(param->Gfermi*Vub*param->mass_tau*param->f_B*(1.-param->mass_tau*param->mass_tau/param->m_B/param->m_B),2.);

	if(param->THDM_model==0) return param->life_B/hbar*param->m_B/8./pi*pow(param->Gfermi*Vub*param->mass_tau*param->f_B*(1.-param->mass_tau*param->mass_tau/param->m_B/param->m_B)	
	*(1.-param->m_B*param->m_B/param->mass_H/param->mass_H*param->tan_beta*param->tan_beta/(1.+epsilon_0(param)*param->tan_beta)),2.);

	else return param->life_B/hbar*param->m_B/8./pi*pow(param->Gfermi*Vub*param->mass_tau*param->f_B*(1.-param->mass_tau*param->mass_tau/param->m_B/param->m_B)	

...
param->m_Ds/8./pi*pow(param->Gfermi*Vcs*param->mass_tau*param->f_Ds*(1.-param->mass_tau*param->mass_tau/param->m_Ds/param->m_Ds),2.)*param->life_Ds/hbar;
	...
	if(param->THDM_model>0) return param->m_Ds/8./pi*pow(param->Gfermi*Vcs*param->mass_tau*param->f_Ds*(1.-param->mass_tau*param->mass_tau/param->m_Ds/param->m_Ds)*(1.+param->m_Ds*param->m_Ds/param->mass_H/param->mass_H*(mc*param->lambda_u[2][2]-ms*param->lambda_d[2][2])*param->lambda_l[3][3]/(ms+mc)),2.)*param->life_Ds/hbar;
	...
	return param->m_Ds/8./pi*pow(param->Gfermi*Vcs*param->mass_tau*param->f_Ds*(1.-param->mass_tau*param->mass_tau/param->m_Ds/param->m_Ds)*(1.+param->m_Ds*param->m_Ds/param->mass_H/param->mass_H*(mc-ms*param->tan_beta*param->tan_beta/(1.+epsilon0*param->tan_beta))/(ms+mc)),2.)*param->life_Ds/hbar;
}
